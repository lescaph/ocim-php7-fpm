...
RUN apt-get install -y php7.0-fpm php7.0 php7.0-mysql php7.0-pgsql php7.0-curl php7.0-mcrypt php7.0-intl php7.0-bz2 php7.0-fileinfo php7.0-imap php7.0-gd wkhtmltopdf
